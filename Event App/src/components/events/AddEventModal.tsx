...
export function AddEventModal({
    ...
    const { values, errors, isLoading, handleChange, handleSubmit, reset } = useForm({ initialValues, validate, onSubmit });
                ...
                <form onSubmit={handleSubmit} className="p-4" >
                    <div className="space-y-4">
                        ...
                        <InputGroup name="description" label="Description"
                            ...
                            error={errors.description} isTextArea />
                        <InputGroup name="date" label="Date and Time"
                            value={values.date} onChange={handleChange}
                            error={errors.date} type="datetime-local" />
