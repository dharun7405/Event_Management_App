...
export function AttendeeHeader({ attendees, isOwner,
    ...
    return (
        <div className="mb-1 flex items-center justify-between">
            ...
            {isOwner && (<Button variant="secondary" size="small"
                icon={<PlusIcon className="h-4 w-4" />} onClick={() => setIsAddAttendeeModalOpen(true)}
            >Add Attendee
            </Button>)}
        </div>
    )
